...
/* List class is imported as module which contain functionality of status */
...
const uploadHtml = () => {
  ...
  list.index - 1
    ...
    ulList.innerHTML = '<li class="red">Nothing to Show !! Add Some Task</li>';
  }
